...
ListView  listView,listView2,listView3,listView4,listView5,listView6,listView7;
...
ArrayAdapter<String> adapter,adapter2,adapter3,adapter4,adapter5,adapter6,adapter7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView6=(ListView)findViewById(R.id.l6);
        listView7=(ListView)findViewById(R.id.l7);
        /*list=new ArrayList<>();
...
firebaseAuth=FirebaseAuth.getInstance();
      ...
      /*  DatabaseReference df6=FirebaseDatabase.getInstance().getReference().child("Candidates");
        Query ref6=df6.child("Joint Cultural Secretary").orderByChild("Count");
        list6=new ArrayList<>();
        adapter6=new ArrayAdapter<String>(this,R.layout.user_info,R.id.userInfo1,list6);
        ...
        ref6.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    user=ds.getValue(User.class);
                    list6.add(user.getName().toString()+" : "+user.getCount());
                }
        ...
        DatabaseReference df7=FirebaseDatabase.getInstance().getReference().child("Candidates");
        Query ref7=df7.child("Joint Treasurer").orderByChild("Count");
        list7=new ArrayList<>();
        adapter7=new ArrayAdapter<String>(this,R.layout.user_info,R.id.userInfo1,list7);
        ...
        ref7.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    user=ds.getValue(User.class);
                    list7.add(user.getName().toString()+" : "+user.getCount());
                }
